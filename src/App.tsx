...
const App = () => {
  return (
    <Routes>
      ...
      />
      <Route
        path="/dailychallenge2"
        element={<DailyChallenge2 />}
      />
      <Route
        path="/dailychallenge3"
        element={<DailyChallenge3 />}
      />
      <Route
        path="/pointshop"
        element={<PointShop />}
      ...
      />
      <Route
        path="/petTalk/:petTalkId"
        element={<PetTalkDetail />}
      />
      <Route
        path="/petTalk/concern"
        element={<Concern />}
      />
      <Route
        path="/petTalk/freetalk"
        element={<FreeTalk />}
      />
      <Route
      ...
      />
      <Route
        path="/petTalk/freetalkwrite"
        element={<FreetalkWrite />}
      />
      {/* 펫 프로필 */}
      <Route
        path="/petprofileadd"
