...
import { privacySheetState } from "@/store/signupState";
...
const PrivacyeBottom: React.FC<BottomSheetProps> = ({ children, height = 60 }) => {
  const [isOpen, setIsOpen] = useRecoilState(privacySheetState);
